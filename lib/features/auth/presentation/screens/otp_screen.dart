        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 8.h),
              Text(
                AppStrings.pleaseEnterThe4DigitCodeSentToPhoneThroughSms
                    .trParams({
                      'countryCode': controller.countryCode.value,
                      'phoneNumber': TanzaniaPhoneFormatter.formatString(
              ...
              AppCupertinoTextButton.primaryUnderlinedLink(
                label: AppStrings.editYourPhoneNumber.tr,
                onPressed: () => Get.back(),
              ),
