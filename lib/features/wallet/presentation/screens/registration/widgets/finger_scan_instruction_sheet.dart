              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "1. Ensure your hand is steadily placed on a stable surface and your fingertips are clearly in focus.",
                      style: AppTextStyles.screenTitle.copyWith(
                        color: AppColors.textGrey,
                        fontSize: 13.0.sp,
                      ),
                    ...
                    Text(
                      "2. Make sure there is an ample lighting condition",
                      style: AppTextStyles.screenTitle.copyWith(
                        color: AppColors.textGrey,
                        fontSize: 13.0.sp,
                      ),
                  ...
                  onTap: () async {
                   ...
                   Get.back();
                    ...
                    if (result) {
                      ...
                      selcomIdentyPlugin.options.languageCode ="en";
