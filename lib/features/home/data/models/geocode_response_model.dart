...
class GeocodeResult {
  ...
  factory GeocodeResult.fromJson(Map<String, dynamic> json) => GeocodeResult(
    addressComponents: json["address_components"] == null
        ? []
        : List<GeocodeAddressComponent>.from(
            json["address_components"]!.map(
              (x) => GeocodeAddressComponent.fromJson(x),
            ),
          ),
    formattedAddress: json["formatted_address"],
    geometry: json["geometry"] == null
        ? null
        : GeocodeGeometry.fromJson(json["geometry"]),
    navigationPoints: json["navigation_points"] == null
        ? []
        : List<GeocodeNavigationPoint>.from(
            json["navigation_points"]!.map(
              (x) => GeocodeNavigationPoint.fromJson(x),
            ),
          ),
    placeId: json["place_id"],
    plusCode: json["plus_code"] == null
        ? null
        : GeocodePlusCode.fromJson(json["plus_code"]),
...
class GeocodeAddressComponent {
  ...
  GeocodeAddressComponent({this.longName, this.shortName, this.types});

  factory GeocodeAddressComponent.fromJson(Map<String, dynamic> json) =>
...
class GeocodeViewport {
  ...
  GeocodeViewport({this.northeast, this.southwest});

  factory GeocodeViewport.fromJson(Map<String, dynamic> json) =>
      GeocodeViewport(
        northeast: json["northeast"] == null
            ? null
            : GeocodeLocation.fromJson(json["northeast"]),
        southwest: json["southwest"] == null
            ? null
            : GeocodeLocation.fromJson(json["southwest"]),
      );
}
...
class GeocodeNavigationPoint {
  ...
  GeocodeNavigationPoint({this.location, this.restrictedTravelModes});

  factory GeocodeNavigationPoint.fromJson(Map<String, dynamic> json) =>
      GeocodeNavigationPoint(
        location: json["location"] == null
            ? null
            : GeocodeNavLocation.fromJson(json["location"]),
...
class GeocodeNavLocation {
  ...
  GeocodeNavLocation({this.latitude, this.longitude});
...
class GeocodePlusCode {
  ...
  GeocodePlusCode({this.compoundCode, this.globalCode});

  factory GeocodePlusCode.fromJson(Map<String, dynamic> json) =>
      GeocodePlusCode(
