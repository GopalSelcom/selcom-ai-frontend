...
bool isSpinKitFadingCircleVisible() {
  return _activeLoaderCount > 0;
}

int _activeLoaderCount = 0;

void _increaseLoaderCount() {
  _activeLoaderCount++;
}

void _decreaseLoaderCount() {
