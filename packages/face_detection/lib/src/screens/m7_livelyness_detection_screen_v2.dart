...
class _M7LivelynessDetectionScreenAndroidState
  ...
  Future<void> _processImage(InputImage img, List<Face> faces) async {
    try {
      ...
      debugPrint("Face Symmetry: $average");
  ...
  void _detect({
    ...
    if (leftEyePosition != null && rightEyePosition != null) {
      ...
      debugPrint("Golden Ratio: $goldenRatio");
    }
    switch (step) {
      case M7LivelynessStep.blink:
        const double blinkThreshold = 0.25;
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: CameraAwesomeBuilder.custom(
                          ...
                          // saveConfig: SaveConfig.photo(
                          //     pathBuilder: (sensorList) async {
                          //       bool getSensorType(List<Sensor> sensors) {
                          //         for (Sensor sensor in sensors) {
                          //           if (sensor.position ==
                          //               SensorPosition.back) {
                          //             return true; // Return true immediately if a back sensor is found.
                          //           }
                          //         }
                          //         return false; // Return false if no back sensor is found after checking all sensors.
                          //       }

                          //       var sensorIsBack = getSensorType(sensorList);
